...
<?php } else { ?>
	...
	?>
		<li id="comment-<?php echo $comment->id; ?>" class="comment-row comment-style-<?php echo $counter % 2; ?> <?php echo ($comment->depth > 0) ? 'comment-replied' : ''; ?>" <?php echo ($comment->depth > 0) ? 'style="margin-'.$indentDirection.':' . ($comment->depth * 75) . 'px;"' : ''; ?> >
			...
			<div class="comment-block clearfix">
				...
				<div class="comment-content">
					<div class="comment-head prel">
						...
						<span class="comment-action float-r">
					...
					<div class="comment-body prel">
						<div>
							...
							<p><b class="comment-title rip mbs" id="comment-title-<?php echo $comment->id;?>"><?php echo $comment->title; ?></b></p>
							<?php } ?>
