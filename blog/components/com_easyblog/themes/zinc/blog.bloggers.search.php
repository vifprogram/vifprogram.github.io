...
<div id="bloggers-sorting">
	<form name="frmBlogger" id="frmBlogger" action="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=blogger' ); ?>" method="post" class="blogger-filter">
		...
		<input type="text" name="search" value="<?php echo $this->escape( $search );?>" class="form-control width-200" />
		<?php echo $sortHTML; ?>
		<input class="butt butt-primary" type="submit" value="<?php echo JText::_('COM_EASYBLOG_FILTER');?>" name="btnSubmit" id="btnSubmit" />
	</form>
</div>
