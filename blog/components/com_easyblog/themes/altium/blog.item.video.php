...
?>
<!-- Post item wrapper -->
<div id="entry_<?php echo $row->id; ?>" class="blog-post micro-video clearfix prel<?php echo (!empty($row->team)) ? ' teamblog-post' : '' ;?>" itemscope itemtype="http://schema.org/Blog">
	<div class="blog-post-in">

		<!-- Post metadata -->
		<?php echo $this->fetch( 'blog.meta.php' , array( 'row' => $row, 'postedText' => JText::_( 'COM_EASYBLOG_VIDEO_SHARED' ) , 'loadAdminTools' => true ) ); ?>
