...
<div id="ezblog-body">
	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read clearfix">
		...
		<div class="blog-head clearfix">
			<!-- Post title -->
			<time class="blog-calendar" datetime="<?php echo $this->formatDate( '%Y-%m-%d' , $blog->created ); ?>">
				<b class="blog-calendar-month"><?php echo $this->formatDate( '%b' , $blog->created ); ?></b>
				<b class="blog-calendar-day"><?php echo $this->formatDate( '%d' , $blog->created ); ?></b>
			</time>

			<div class="blog-cap">
				<h2 id="title-<?php echo $blog->id; ?>" class="blog-title<?php echo ($isFeatured) ? ' featured-item' : '';?> rip"><?php echo $blog->title; ?></h2>
		...
		<div class="blog-text clearfix prel mtl mbl">
