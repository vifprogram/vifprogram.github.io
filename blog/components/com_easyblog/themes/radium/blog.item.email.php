...
<div id="entry-<?php echo $row->id; ?>" class="blog-post micro-email clearfix prel<?php echo (!empty($row->team)) ? ' teamblog-post' : '' ;?>">
	<div class="blog-post-in">
		...
		<div class="blog-header clearfix">
			...
			<!-- Post title -->
			<time class="blog-calendar" datetime="<?php echo $this->formatDate( '%Y-%m-%d' , $row->created ); ?>">
				<b class="blog-calendar-month"><?php echo $this->formatDate( '%b' , $row->created ); ?></b>
				<b class="blog-calendar-day"><?php echo $this->formatDate( '%d' , $row->created ); ?></b>
			</time>
